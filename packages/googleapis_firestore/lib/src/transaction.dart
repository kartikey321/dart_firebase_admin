...
class Transaction {
  ...
  ///   );
  ///
  ///   final snapshot = await transaction.getAggregation(aggregation);
  ///
  ...
  /// });
  /// ```
  Future<AggregateQuerySnapshot> getAggregation(
  ...
  Future<_TransactionResult<AggregateQuerySnapshot>> _getAggregationFn(
    AggregateQuery aggregateQuery, {
    String? transactionId,
    Timestamp? readTime,
    firestore_v1.TransactionOptions? transactionOptions,
